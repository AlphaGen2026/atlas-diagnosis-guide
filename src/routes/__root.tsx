...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MediAI — klassik tibbiy adabiyotlarga asoslangan AI yordamchi" },
      {
        name: "description",
        content:
          "MediAI shikoyatlaringizni Harrison, Guyton & Hall, Robbins va boshqa klassik tibbiy manbalar asosida tahlil qiladi.",
      },
